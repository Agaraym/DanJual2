...
<html lang="es">
    ...
    <head>
        ...
        <title>sucursal_producto.php</title>
...
<form class="row g-3" style="margin-left:100px; margin-right:100px;">
       <h4 class="text-center">SUCURSAL PRODUCTO</h4>
        <div class="col-12">
            <div class="col-md-8">
                <input type="text" class="form-control" id="id" name="ing	id  " placeholder="	id">
                
                </div>  
        </div>

        <div class="col-md-6">
        <p><input type="text" class="form-control" id="numUnico_scrsl " name="ingnumUnico_scrsl " placeholder="numUnico_scrsl"></p>


        </div>
        <div class="col-md-6">
        <input type="text" class="form-control" id="cod_producto" name="ingcod_producto" placeholder="cod_producto">
