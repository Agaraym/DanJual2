...
<form  action ="agregar_usuarios.php" class="row g-3"  method="post"  enctype="multipart/form-data" style="margin-left:100px; margin-right:100px;">
       <h4 class="text-center">USUARIOS</h4>
        ...
        <div class="col-md-6">
        <p> <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" placeholder="nombre_usuario"></p>
        ...
        <div class="col-md-6">
         <input type="text" class="form-control" id="text" name="estado" placeholder="estado">
